...
'''
 Quick mockup to provide a meaningful way to do mass replacements of
 files via a configuration file instead of hard-coding.
...
# changed from string replace to re.sub but pretty much the same content.
